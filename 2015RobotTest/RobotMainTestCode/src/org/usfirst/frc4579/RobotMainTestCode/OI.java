...
public class OI {
    ...
    public OI() {
        ...
        joystickButton4.whenPressed(new DeliverCylinder());
        joystickButton3 = new JoystickButton(joystick, 3);
        joystickButton3.whenPressed(new Place());
        joystickButton2 = new JoystickButton(joystick, 2);
        joystickButton2.whenPressed(new PickUp());
        joystickButton1 = new JoystickButton(joystick, 1);
        joystickButton1.whenPressed(new PreparetoPickup());
