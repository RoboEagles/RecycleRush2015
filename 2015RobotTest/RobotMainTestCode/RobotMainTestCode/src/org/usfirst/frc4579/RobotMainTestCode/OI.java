...
public class OI {
    ...
    public JoystickButton prepPickupButton;
    public JoystickButton pickupButton;
    public JoystickButton palceButton;
    public JoystickButton deliverButton;
    ...
    public OI() {
        ...
        deliverButton = new JoystickButton(joystick, 4);
        deliverButton.whenPressed(new DeliverCylinder());
        palceButton = new JoystickButton(joystick, 3);
        palceButton.whenPressed(new Place());
        pickupButton = new JoystickButton(joystick, 2);
        pickupButton.whenPressed(new PickUp());
        prepPickupButton = new JoystickButton(joystick, 1);
        prepPickupButton.whenPressed(new PreparetoPickup());
        ...
        SmartDashboard.putData("Deliver Cylinder", new DeliverCylinder());

        SmartDashboard.putData("Drive To Platform", new DriveToPlatform());
